	...
	[AppThemePreset.Aurora]: {
		...
		modes: {
			[AppSettingsTheme.Dark]: createThemeMode({
				...
				panelBackground: "rgba(18, 17, 38, 0.82)",
				siderBackground: "rgba(9, 8, 23, 0.78)",
				headerBackground: "rgba(9, 8, 23, 0.68)",
				atmosphere:
			...
			[AppSettingsTheme.Light]: createThemeMode({
				...
				panelBackground: "rgba(255, 252, 255, 0.78)",
				siderBackground: "rgba(249, 244, 255, 0.76)",
				headerBackground: "rgba(255, 252, 255, 0.70)",
				atmosphere:
	...
	[AppThemePreset.Prism]: {
		...
		modes: {
			[AppSettingsTheme.Dark]: createThemeMode({
				...
				panelBackground: "rgba(34, 26, 51, 0.88)",
				atmosphere:
			...
			[AppSettingsTheme.Light]: createThemeMode({
				...
				panelBackground: "rgba(255, 252, 250, 0.84)",
				siderBackground: "rgba(255, 247, 242, 0.78)",
				headerBackground: "rgba(255, 252, 250, 0.74)",
				atmosphere:
				...
				backdropFilter: "blur(15px) saturate(125%)",
				logoBackground:
	...
	[AppThemePreset.Glacier]: {
		...
		modes: {
			[AppSettingsTheme.Dark]: createThemeMode({
				...
				panelBackground: "rgba(11, 29, 42, 0.73)",
				siderBackground: "rgba(6, 19, 30, 0.76)",
				headerBackground: "rgba(6, 19, 30, 0.66)",
				atmosphere:
			...
			[AppSettingsTheme.Light]: createThemeMode({
				...
				green: "#08785F",
				yellow: "#8A6200",
				recommendedAccent: "#0075AD",
				panelBackground: "rgba(248, 253, 255, 0.72)",
				siderBackground: "rgba(234, 246, 252, 0.72)",
				headerBackground: "rgba(248, 253, 255, 0.64)",
				atmosphere:
...
export const resolveThemePrimaryColor = (
	...
	try {
		...
		const canvas = Color(runtime.palette.canvas);
		if (candidate.contrast(canvas) >= 3) {
