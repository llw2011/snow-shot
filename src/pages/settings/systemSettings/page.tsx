...
export const SystemSettingsPage = () => {
	...
	return (
		<ContentWrap className="settings-wrap">
			...
			{currentPlatform === "macos" && <MacOSPermissionsSettings />}
			...
			<SettingsSection
				sectionId="scrollScreenshotSettings"
				title={
			...
			<SettingsSection
				sectionId="dataFile"
				title={<FormattedMessage id="settings.systemSettings.dataFile" />}
			>
